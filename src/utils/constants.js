...
export const depressed_LL_msg = "Log likelihood of the text showing emotional distress: ";
export const nondepressed_LL_msg = "Log likelihood of the text showing positivity: ";